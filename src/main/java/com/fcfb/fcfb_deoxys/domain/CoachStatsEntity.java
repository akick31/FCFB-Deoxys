...
@Entity
@Table(name = "coach_stats", schema = "deoxys")
public class CoachStatsEntity {
    @Id
    @Column(name = "id")
    private Integer id;
    @Basic
